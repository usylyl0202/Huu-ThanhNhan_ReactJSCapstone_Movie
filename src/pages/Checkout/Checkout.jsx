      ...
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-3 mt-2">
          ...
          <div className="flex flex-col my-5">
            <div className=''>
              ...
              {_.sortBy(danhSachGheDangDat, ['maGhe', 'stt']).map((gheDD, index) => {
                return <span className='text-green-500' key={index}> [{gheDD.stt}]</span>
              })}
            </div>
          </div>
          <hr />
          ...
          <div className="flex flex-col-reverse justify-center items-center">
            <button className='mt-5 block w-full text-2xl bg-green-500 px-3 text-center text-white py-3 font-bold'
              onClick={() => {
